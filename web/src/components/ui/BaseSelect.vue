...
<template>
  <div ref="containerRef" class="flex flex-col gap-1.5">
    ...
    <div class="relative">
      <!-- Trigger -->
      <div
        class="w-full flex cursor-pointer items-center justify-between border-3 border-black/10 rounded-xl bg-white px-4 py-2.5 outline-none transition-all duration-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
        :class="{
          'bg-gray-50 text-gray-400 cursor-not-allowed dark:bg-gray-800/50': disabled,
          'ring-2 ring-[#4a8c3f]/30 border-[#4a8c3f] scale-[1.01] dark:focus:border-[#6dbf5b]': isOpen,
          'hover:border-[#4a8c3f]/50': !disabled,
        }"
      ...
      >
        <div
          v-if="isOpen"
          class="absolute left-0 right-0 z-50 mt-1 max-h-60 overflow-auto border-3 border-black/10 rounded-xl bg-white py-1 shadow-[0_4px_0_rgba(0,0,0,0.1),0_4px_16px_rgba(0,0,0,0.1)] dark:border-gray-600 dark:bg-gray-800"
        >
